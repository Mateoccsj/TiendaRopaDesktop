namespace RotiseriaDesktop
{
    partial class FrmFacturaCompra
    {
        ...
        private void InitializeComponent()
        {
            ...
            // CompraBindingSource
            // 
            this.CompraBindingSource.DataSource = typeof(Datos.Compra);
            // 
            // reportViewer1
            // 
            ...
            reportDataSource2.Name = "DetalleCompras";
            reportDataSource2.Value = this.CompraBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "RotiseriaDesktop.FacturaCompra.rdlc";
